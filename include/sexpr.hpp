...
public:
    ...
    static sexpr_t context(const sexpr_t& expr, env_t& local);
    static void unbind(const sexpr_t& expr, env_t& local = global);
    static bool bind(const sexpr_t& rexpr, const sexpr_t& lexpr,
                     env_t& local = global);

    static sexpr_t native_add(const sexpr_t& args, env_t& bindings);
    static sexpr_t native_sub(const sexpr_t& args, env_t& bindings);
    static sexpr_t native_mul(const sexpr_t& args, env_t& bindings);
    static sexpr_t native_div(const sexpr_t& args, env_t& bindings);

    static sexpr_t native_print(const sexpr_t& args, env_t& bindings);
    ...
    static sexpr_t native_islist(const sexpr_t& args, env_t& bindings);
    static sexpr_t native_isnum(const sexpr_t& args, env_t& bindings);
    static sexpr_t native_isnil(const sexpr_t& args, env_t& bindings);
